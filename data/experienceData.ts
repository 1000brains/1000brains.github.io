const experienceData = [
  {
    title: 'Professor of Practice in Design',
  ...
  {
    title: 'Director',
    company: 'Educational Multimedia Research Center (EMMRC)',
    location: 'Pune, India',
    range: 'June 2020 - July 2022',
    url: 'http://www.unipune.ac.in/EMMRC/',
    text1:
      'Spearheaded the production of audio-visual content for MOOCs and conducted capacity building programs for MOOC instructors across India.',
    text2:
      'Led initiatives to inculcate learner-centric approaches in content creation, developed training modules for educators, and established quality standards for educational multimedia production.',
  },
  {
  ...
  {
    title: 'Animation Film Director & Visual Designer',
