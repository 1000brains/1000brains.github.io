...
const projects = [
  {
    ...
    description: "Development of learning objects and interaction design strategies for educational animations.",
    funding: "Ministry of Human Resource Development, Government of India",
    duration: "2015-2018"
  },
  {
    title: "Blender Training Initiative",
    description: "National program to popularize and train personnel in Blender 3D animation software.",
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="space-y-2 pt-6 pb-8 md:space-y-5">
          ...
          <p className="text-lg leading-7 text-gray-500 dark:text-gray-400">
            Exploring the intersection of visual design, educational technology, and learning experiences
          </p>
        </div>
          ...
          <div className="space-y-4">
            {publications.map((pub, index) => (
              <div key={index} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-1">{pub.authors}</p>
        ...
        <div className="py-8">
          ...
          <div className="bg-gradient-to-r from-primary-50 to-primary-100 dark:from-primary-900 dark:to-primary-800 p-8 rounded-lg">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              ...
              <div>
                <div className="text-3xl font-bold text-primary-600 dark:text-primary-400">edX Prize</div>
